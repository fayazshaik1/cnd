    ...
    return (
      <div className="UserProfile">
        <div className="User">
          ...
          <div className="image"><img src="assets/images/cindy.jpg" alt="profile" /></div>
        </div>
      </div>
    );
  }
...
class Hero extends Component {
  ...
  render() {
    return (
      <div id="hero" className="Hero" style={{backgroundImage: 'url(assets/images/narcos-bg.jpg)'}}>
        <div className="content">
          <img className="logo" src="assets/images/narcos-logo.png" alt="narcos background" />
